        ...
        <div className="space-y-1">
          {items.map(item => {
            ...
            return (
              ...
              >
                <Icon className={`h-5 w-5 shrink-0 ${collapsed ? "mx-auto" : "mr-3"}`} />
                {!collapsed && (
  ...
  return (
    <div className="h-screen flex overflow-hidden bg-slate-50 font-sans">
      ...
      >
        <div className="h-14 flex items-center justify-between px-4 border-b border-red-800">
          {collapsed ? (
            <button
              ...
              className="mx-auto p-1.5 rounded hover:bg-[#9B1515] text-white flex items-center justify-center transition-colors"
            >
              <Menu className="h-5 w-5" />
            </button>
          ) : (
            <>
              <Link to="/dashboard" className="flex items-center space-x-2 truncate">
                <div className="h-8 w-8 rounded-full bg-white flex items-center justify-center text-[#B71C1C] font-bold text-lg border border-red-200 shrink-0">
                  S
                </div>
                <span className="font-extrabold text-lg tracking-wide uppercase font-serif text-white">
                  Surya CRM
                </span>
              </Link>
              <button
                onClick={() => setCollapsed(true)}
                className="p-1.5 rounded hover:bg-[#9B1515] text-white flex items-center justify-center shrink-0 transition-colors"
              >
                <Menu className="h-5 w-5" />
              </button>
            </>
        ...
        <nav className="flex-grow py-4 overflow-y-auto overscroll-contain custom-scrollbar">
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 flex md:hidden">
          ...
          />
          <aside className="relative flex flex-col w-72 max-w-xs bg-[#B71C1C] text-white h-full overflow-y-auto overscroll-contain">
            <div className="h-14 flex items-center justify-between px-4 border-b border-red-800">
